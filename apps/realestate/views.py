...
def get_cheapest_product(request,*args, **kwargs):
    ...
    return render (request,"realestate_app/partials/cheapest_product.html",context)
#--------------------------------------------------------------------
...
def get_last_product(request,*args, **kwargs):
    ...
    return render (request,"realestate_app/partials/last_product.html",context)
#--------------------------------------------------------------------
## گروه محصولات محبوب
def get_popular_product_groups(request,*args, **kwargs):
    ...
    return render (request,"realestate_app/partials/popular_product_groups.html",context)
#--------------------------------------------------------------------
## جزئیات محصول 
class productDetaileView(View):
    def get(self,request,slug):
        ...
        if product.is_active:
            return render (request,"realestate_app/product_details.html",{'product':product})
#--------------------------------------------------------------------
...
def get_related_products(request,*args, **kwargs):
    ...
    return render (request,"realestate_app/partials/related_products.html" ,{'related_product':related_product})
...
class ProductGroupView(View):
    def get(self, request):
        product_groups = ProductGroup.objects.filter(Q(is_active = True))\
                     .annotate(count = Count('products_of_groups'))\
                     .order_by('-count')
        return render(request,"realestate_app/product_groups.html",{'product_groups':product_groups})
#------------------------------ filters --------------------------------------
...
def get_product_groups(request):
    ...
    return render(request,'realestate_app/partials/product_groups.html',{'product_groups':product_groups})
...
def get_brands(request,*args, **kwargs):
    ...
    return render(request,'realestate_app/partials/brands_filter.html',{'brands':brands})
#--------------------------------------------------------------------
...
def get_feature_for_filter(request,*args, **kwargs):
    ...
    return render(request,'realestate_app/partials/features_filter.html',{'feature_dict ':feature_dict })
...
class ProductsBygroupView(View):
    def get(self,request,*args, **kwargs):
        ...
        return render(request,"realestate_app/products.html",context)
...
class ShowCompareListView(View):
    def get(self, request, *args, **kwargs):
        ...
        return render(request,'realestate_app/compare_list.html', context)
#----------------------------------------------------------------
# for create AVg
...
def compare_table(request):
    ...
    for product in products: 
        ...
        return render(request,'realestate_app/partials/compare_table.html',context)
#----------------------------------------------------------------
...
def delete_from_compare_list(request):
    ...
    return redirect("realestate:compare_table")
